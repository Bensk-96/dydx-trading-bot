...
# Calculate Cointegration - Update
# def calculate_cointegration(series_1, series_2):
#   series_1 = np.array(series_1).astype(np.float)
#   series_2 = np.array(series_2).astype(np.float)
#   coint_flag = 0
